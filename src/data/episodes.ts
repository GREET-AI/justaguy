...
export const episode1Scenes: EpisodeScene[] = [
  ...
  { 
    ...
    description: "Berlin. Solao finally cracks the code – tokens that can never be bundled again.", 
    video: "SC02_solao_sits_on_his_de_2025_11_22T19_28_48_909Z_20251124111204895.mp4",
  ...
  { 
    ...
    description: "Kreuzberg basement. Solao and his crew plan the coin – and how hard they will rug.", 
    video: "SC06_....mp4",
  ...
  { 
    ...
    description: "Solao drops a cold-blooded tutorial: How to perfectly rug on Pump.fun in 2025.", 
    video: "SC07_....mp4",
  ...
  { 
    id: "SC09", 
    title: "First Contact", 
    description: "Berlin rooftop. Blue meets Solao and the gang – alliance sealed.", 
    video: "SC09_....mp4",
...
export const mainEpisode = {
  ...
  description: "The complete first episode of THE GREAT RUG",

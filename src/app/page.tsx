...
const featureTiles = [
  ...
  },
  {
    ...
    title: "Meet the Cast",
    copy:
      "Solao, the realest dev in the space. Trump, Elon, Blue, and more. Each character brings their own chaos to this cinematic universe.",
...
const reelScenes = [
  ...
  {
    title: "Solao at His Desk",
    tag: "Scene 02",
    file: "/Episode1/Final Scenes/Scene 2.mov",
    description: "Meet Solao, the realest dev in the space. This is where it all starts.",
  },
  {
    title: "Trump Enters",
    tag: "Scene 03",
...
const memeLoop = [
  { emoji: "🪙", title: "The Token", copy: "$GREATRUG powers the entire series. Every trade funds the next episode." },
  { emoji: "🎬", title: "Episode I: On a Flight to Germany", copy: "The premiere is live. Watch the story unfold in real-time." },
  { emoji: "🎭", title: "The Characters", copy: "Trump, Elon, Solao, Blue, and more. Meet the cast." },
  { emoji: "📺", title: "TV Series", copy: "This isn't just a coin. It's a cinematic experience." },
  { emoji: "🔥", title: "The Story", copy: "BTC-2025. The year everything changed. The rug that changed everything." },
  { emoji: "💎", title: "100% Safe", copy: "LP burned. Contract renounced. The dev never rugs. Ever." },
];

const marqueeQuotes = [
  "\"I will never rug you. Trading fees keep the lights on, pay the animators.\" — Solao",
  ...
  "\"I'd rather die than go back to a 9-5. This is my lifetime project.\" — Solao's Oath",
...
const marqueeQuotes2 = [
  ...
  "\"Trump, Elon, Solao - characters you know, stories you've never seen.\" — The Cast",
...
const marqueeQuotes4 = [
  "\"Solao vs. The World. David vs. Goliath. The ultimate crypto showdown.\" — The Battle",
...
const marqueeQuotes5 = [
  "\"The great rug that never rugs. The promise that never breaks.\" — The Paradox",
  ...
  "\"Welcome to THE GREAT RUG. Welcome to the future.\" — The Welcome",
];
  ...
  },
  {
    ...
    cards: [
      ...
      { 
        ...
        statusColor: "teal",
        progress: 0,
        tweetText: "BTC-2025 just dropped.  \n\nTrump. Elon. Rothschild. Solao.  \n\nThe greatest rug in history is live.  \n\nEpisode I → https://thegreatrug.com  \n\n$GREATRUG \n\nhttps://t.me/thegreatrug"
      },
      { 
        name: "TELEGRAM GROWTH", 
        status: "0 → 10,000 MEMBERS", 
        note: "Help us reach the milestone", 
        colors: ["#00D1FF", "#14F195"], 
        logo: "/Website/cryptologos/Telegram Logo.png",
        statusColor: "teal",
        progress: 5
      },
    ],
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1600px] flex-col gap-20 md:gap-28">
                ...
                <div className="video-preview-container">
                  ...
                  >
                    <img 
                      ...
                      src={`https://img.youtube.com/vi/36EbQGVU0Sc/maxresdefault.jpg`}
        ...
        <Image
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-white/80 font-montserrat leading-relaxed">
            ...
            memecoins, and the ultimate rug pull. Episode I is live. The story begins now.
          </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm">
          <div className="relative w-full max-w-6xl mx-4 aspect-video">
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/36EbQGVU0Sc?autoplay=1&rel=0&modestbranding=1"
    ...
    <section id="episodes" className="relative px-6 py-20 md:px-14 md:py-32">
      ...
      >
        <div className="space-y-6 md:space-y-8">
          ...
          <p className="text-lg text-white/70">
            Watch the first episode of THE GREAT RUG. Meet the characters. Experience the story. Join the movement.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 mt-16">
          {listingColumns.slice(0, 4).map((column, columnIndex) => (
              ...
              >
                <div className="glass listing-column-inner relative">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-lg uppercase tracking-wider opacity-80 text-white font-medium">
                      {column.label}
                    </h3>
                  ...
                  <div className="listing-card-stack">
                    {column.cards.map((card, cardIndex) => (
                      ...
                      >
                        <motion.div 
                          className={`group relative overflow-hidden p-6 rounded-3xl border border-white/10 bg-black/60 backdrop-blur ${
            ...
            <Image
                                ...
                                <div>
                                  <p className={`text-2xl font-bold md:text-2xl leading-tight ${
                              ...
                              <div className="flex flex-col items-end gap-2">
                                <span className={`text-sm font-bold px-4 py-1.5 rounded-full whitespace-nowrap ${
                            ...
                            <div className="space-y-3">
                              ...
                              {(card.status.includes("COMMUNITY") || card.status.includes("VOTE")) && (
                                <motion.a
                                  href={(card as any).link || "https://t.me/thegreatrug"}
            target="_blank"
            rel="noopener noreferrer"
...
function FutureDreams() {
  const futureDreams = [
    ...
    {
      title: "THE FINAL RUG",
      subtitle: "Just kidding. We never rug 😉",
      description: "This is Solao's lifetime project. Diamond hands forever.",
      icon: "💎",
    ...
    <section className="px-6 md:px-14">
      ...
      >
        ...
        <p className="text-white/70">
          Every trade funds the next episode. Every holder becomes part of the story. This is THE GREAT RUG.
        </p>

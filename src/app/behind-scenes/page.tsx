...
const chapters: Chapter[] = [
  {
    ...
    number: 1,
    title: 'The Artist',
    content: 'Solao isn\'t just a dev. He\'s the most respected underground artist in the entire Solana scene. Years of perfecting characters, storytelling and satire – long before the coin existed. He turned down every VC that wanted to own his soul. Now he builds his own empire – on his terms.',
    type: 'artist'
  },
  {
    id: 'team',
    ...
    teamMembers: [
      ...
      {
        role: 'Story & Script',
        name: 'Solao + Two Anonymous Writers',
                    ...
                    <div className="aspect-square bg-gradient-to-br from-[#14F195]/20 to-[#FB2BFF]/20 rounded-3xl border-2 border-yellow-400/40 p-8 group-hover:border-yellow-400/80 transition-all duration-500">
                      <div className="w-full h-full bg-black rounded-2xl overflow-hidden border border-gray-700 group-hover:border-yellow-400/60 transition-all duration-500">
                        <img
                          ...
                          alt="Solao - The Greatest Artist in Crypto"

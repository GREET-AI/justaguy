...
const characters: Character[] = [
  ...
  },
  {
    ...
    backgroundStory: 'Once Africa\'s most notorious crypto scammer. Rugged entire villages with fake DeFi projects. Had a change of heart after meeting Solao. Now uses his skills to expose other ruggers. Still has trust issues.',
    quotes: [
  ...
  },
  {
    ...
    backgroundStory: 'The mysterious creator of THE GREAT RUG. Claims to be fighting the system from within. Creates educational content disguised as entertainment. Nobody knows his real identity, but his mission is clear: expose the truth.',
    quotes: [
